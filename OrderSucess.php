...
$string1="ordername='$ordername',qty='$cart[qty]',img='$products[primary_image]',price='$price',user_id='$user_ip',vendor_id='$cart[shop_id]',shipping_type='$ship_typ',shipping_charge='$shipChar',order_id='$order_id',address_id='$addres_id',payment_mode='$pay_mode',wallet='$wallet_deduc',txn_id='$txnid',created_date=NOW()";
