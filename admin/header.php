...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="" class="logo">
      ...
      <span class="logo-mini"><?php echo $page['title'];?> </span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><?php echo $page['title'];?></span>
    </a>
    ...
    <nav class="navbar navbar-static-top" role="navigation">
      ...
      <div class="navbar-custom-menu">
        ...
        <img src="images/thumb/<?php echo $profile['profile_image'];?> "  class="user-image" alt="User Image" >
        <?php }else{?>
         <img src="images/default.png" class="img-circle" alt="User Image"  width="50px">
        <?php }?>
              <!-- hidden-xs hides the username on small devices so only the image appears. -->
              <span class="hidden-xs"> User Name:<?php echo $profile['full_name'];?></span>
            </a>
