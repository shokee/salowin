...
<?php include('sidebar.php')?>
  ...
  if(isset($_REQUEST['submit']) && $_REQUEST['submit']=='addproduct'){
    ...
    $string="product_name='$product_name', description='$description', brands_id='$brands_id', primary_image='$fname1',status='0', created_date=NOW()";
    ...
    header("Location:product.php?msg=succes");exit;
  }
?>
       ...
       <div class="row">
        ...
        <div class="col-md-12">
          ...
          <?php if(isset($_REQUEST['msg']) && $_REQUEST['msg']=='succes'){?>
              ...
              <p>Your Product Add Successfully , Please Wait For Admin Approval.</p>
              </div>
              <?php }?>
          <div class="row">
          	<div class="col-sm-6">
            <!-- form start -->
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="editor1" name="description" id="description" required></textarea>
                </div>
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <?php  $vendcat = $dbf->fetchSingle("vendor_catagory",'*',"vendor_id='$profileuserid'");?>
                   ...
                   <?php
					$i=1;
					 foreach($dbf->fetchOrder("vendor_catagory","vendor_id='$profileuserid'","vendor_catagory_id ASC","","") as $vendcat){
					?>
                    
        <?php  foreach($dbf->fetchOrder("product_catagory_1","product_catagory_1_id='$vendcat[catagory_id]'","product_catagory_1_name","","") as $product_catagory_1){?>
